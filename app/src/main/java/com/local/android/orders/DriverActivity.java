...
public class DriverActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnEnd = findViewById(R.id.track_btnStop);
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (location != null) {
            ...
            Call<Fetch> call = service.fetch("2", location.getLatitude() + "", location.getLongitude() + "");
